# Derivative Features & Inspiration Report: FakeSE

This report outlines the conceptual lineage of the features implemented in **FakeSE**, mapping them to established industry solutions and platforms that provided the blueprints for our trading, simulation, and competition modules.
...
> [!IMPORTANT]
> The Competition module is the "Secret Sauce" of FakeSE, transforming a solo trading experience into a multi-player arena.
...
1. **[Codeforces](https://codeforces.com/)**
   ...
   - **Connection**:
     ...
     - **Contest-Virtual Balance**: We've adapted the concept of "Virtual Participation" and "Contest Standing." In FakeSE, users trade with a dedicated "Contest Balance" that is isolated from their main portfolio, allowing for high-stakes competition without risk.
     - **The "Flex" Factor**: Much like Codeforces users showcase their "Grandmaster" or "Specialist" tags, FakeSE is built for users to showcase their portfolio growth and ranking within a specific time-bound arena. It's about the social prestige of being a "Top Trader."
